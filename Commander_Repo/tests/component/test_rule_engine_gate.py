...
from unittest.mock import MagicMock  # pyright: ignore[reportUnusedImport]
...
class TestRuleEngineWithGate:
    def test_high_severity_fire_is_gated(self, registry_with_leaders: Any, fire_state: Any, high_fire_record: Any, fake_dispatcher: Any, fake_mqtt: Any) -> None:
    ...
    def test_fire_dispatch_causes_dual_write(self, registry_with_leaders: Any, fire_state: Any, fake_dispatcher: Any, fake_mqtt: Any) -> None:
        ...
        results = engine.evaluate(fire_from_store, ctx)  # pyright: ignore[reportUnusedVariable]
