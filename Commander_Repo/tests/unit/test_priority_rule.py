...
class TestPriorityRule:
    ...
    def test_preempts_lower_priority_fire(self, fires_store: Any) -> None:
        ...
        new_fire = FireRecord(fire_id="new-critical", state=ACTIVE, zone="zone_b", severity="CRITICAL", sensor_id="s2")
        ctx = RuleContext(
    ...
    def test_no_preempt_for_lower_priority(self, fires_store: Any) -> None:
        ...
        new_fire = FireRecord(fire_id="new-low", state=ACTIVE, zone="zone_b", severity="LOW", sensor_id="s2")
        ctx = RuleContext(
            trigger=EvalTrigger.NEW_FIRE,
            event_log=None,  # pyright: ignore
            fires_store=fires_store,
    ...
    def test_no_preempt_when_leaders_available(self) -> None:
        ...
        new_fire = FireRecord(fire_id="new-fire", state=ACTIVE, zone="zone_b", severity="CRITICAL", sensor_id="s2")
        ctx = RuleContext(
            trigger=EvalTrigger.NEW_FIRE,
            event_log=None,  # pyright: ignore
