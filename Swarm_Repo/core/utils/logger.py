...
_log_fh    = None
_USE_COLOR: Final[bool] = (sys.stdout.isatty() or os.getenv("FORCE_COLOR", "0") == "1") and os.getenv("NO_COLOR", "") == ""
if _LOG_FILE:
    try:
...
def log(tag: str, msg: str, channel: str = "SYSTEM", level: str = "INFO") -> None:
    ...
    ts = datetime.datetime.now(datetime.timezone.utc).isoformat(timespec="milliseconds") + "Z"
