...
class MQTTClient:
    ...
    def set_will(self, topic: str, payload: dict[str, Any] | str) -> None:
        ...
        Args:
            topic: The topic to publish the will message on.
            payload: Message payload (dict is JSON-serialized, str used as-is).
        """
    ...
    def subscribe(self, topic: str, qos: int = 0) -> None:
        ...
        Args:
            ...
            qos: Quality of Service level (0 or 1). Higher wins if already subscribed.
        """
    ...
    def publish(self, topic: str, payload: dict[str, Any] | str, qos: int = 0) -> None:
    ...
    def publish_retained(self, topic: str, payload: dict[str, Any] | str, qos: int = 0) -> None:
        """Publish a retained message. Retained messages are re-delivered to any new subscriber.
    ...
    def set_handler(self, fn: Handler) -> None:
        ...
        Args:
            fn: Handler callable receiving (topic, payload).
        """
