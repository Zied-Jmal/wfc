...
def scout_telem():
    return DroneTelemetry(
        ...
        battery_wh=200.0,
        battery_pct=0.85,
        payload_litres=None,  # pyright: ignore[reportArgumentType]
        payload_kg=None,  # pyright: ignore[reportArgumentType]
        task="SCOUTING",
        connectivity="STRONG",
        ...
        litres_delivered=None,
        suppression_effectiveness_pct=None,
        drop_passes=None,
        pump_active=None,
    )
...
def fighter_telem():
    return DroneTelemetry(
        ...
        task="SUPPRESSING",
        connectivity="STRONG",
        thermal_peak_temp_c=None,
        thermal_coverage_pct=None,
        smoke_density_mg_m3=None,
        smoke_optical_density=None,
        flame_height_m=None,
        distance_to_flame_m=80.0,
        perimeter_estimate_m=None,
        wind_speed_mps=None,
        wind_direction_deg=None,
        litres_delivered=5.0,
        suppression_effectiveness_pct=0.5,
        drop_passes=2,
        pump_active=True,
    )
